...
ALTER TABLE bookings ADD COLUMN IF NOT EXISTS rider_ready_lat DOUBLE PRECISION;
ALTER TABLE bookings ADD COLUMN IF NOT EXISTS rider_ready_lng DOUBLE PRECISION;
